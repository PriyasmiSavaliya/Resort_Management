...
Public Class UC_Addroom
    ...
    Private Sub BtnAddroom_Click(sender As Object, e As EventArgs) Handles btnAddroom.Click
        Try
            cn.Open()
            cmd = New OleDbCommand("insert into room values(" & txtRoomid.Text & "," & txtRoomno.Text & ",'" & txtRoomtype.Text & "','" & txtBed.Text & "'
                ,'" & txtPrice.Text & "','" & txtBooked.Text & "')", cn)
            cmd.ExecuteNonQuery()
            MsgBox("Room Added")
            Display()
    ...
    Private Sub Btnupdate_Click(sender As Object, e As EventArgs) Handles btnupdate.Click
        Try
            cn.Open()
            cmd = New OleDbCommand("update room set RoomNumber=" & txtRoomno.Text & ",RoomType='" & txtRoomtype.Text & "',Bed='" & txtBed.Text & "'
            ,Price=" & txtPrice.Text & ",Booked='" & txtBooked.Text & "' where RoomId=" & txtRoomid.Text & "", cn)
            cmd.ExecuteNonQuery()
            Display()
